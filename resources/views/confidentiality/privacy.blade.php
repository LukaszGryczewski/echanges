...
<div class="container">
    <h1 class="my-4">Politique de Confidentialité</h1>
    ...
    <div class="mb-4 card">
        ...
        <div class="card-body">
            Des mesures de sécurité renforcées sont en place pour garantir la protection des données que nous traitons, afin d'éviter tout accès non autorisé à ces informations.
        </div>
    </div>
    ...
    <div class="mb-4 card">
        ...
        <div class="card-body">
            Soyez assurés que nous ne vendons ni ne partageons vos données avec des tiers, à l'exception de ceux directement impliqués dans le processus d'exécution de votre commande. Tous nos collaborateurs et les tiers avec lesquels nous collaborons sont tenus de garantir la confidentialité de vos informations.
        </div>
    </div>
    ...
    <div class="mb-4 card">
        ...
        <div class="card-body">
            Les prix de nos produits sont indiqués en euros, toutes taxes comprises (TVA). La propriété des produits demeure celle de Treasures jusqu'au paiement complet du prix.
        </div>
    </div>
    ...
    <div class="mb-4 card">
        ...
        <div class="card-body">
            En validant votre commande, vous confirmez avoir lu, compris et accepté nos Conditions générales de vente.
        </div>
    </div>
    ...
    <div class="mb-4 card">
        ...
        <div class="card-body">
            Pour garantir la sécurité de vos transactions, nous utilisons le système de paiement sécurisé de Stripe, qui accepte les cartes Visa et Mastercard.
        </div>
    </div>

    <div class="mb-4 card">
        <div class="card-header">
            <h4>Communications téléphoniques</h4>
        </div>
        <div class="card-body">
            Si vous choisissez de partager votre numéro de téléphone avec nous, nous ne l'utiliserons que pour discuter de questions pertinentes à vos commandes en ligne.
        </div>
    </div>
    ...
    <div class="mb-4 card">
        ...
        <div class="card-body">
            Pour toute question ou préoccupation concernant notre politique de confidentialité, n'hésitez pas à nous contacter par e-mail.
        </div>
    </div>
